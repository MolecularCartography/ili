    ...
    return function (container) {
        ...
        require.config({
            ...
            'paths': {
                ...
                /* `ili's objects */
                'volumesettingscontroller': './js/VolumeController/VolumeSettingsController',
                'volumecontroller3d': './js/VolumeController/TabController3D',
                'volumecontrollerdocumentation': './js/VolumeController/TabControllerDocumentation',
                'volumecontrollerexamples': './js/VolumeController/TabControllerExamples',
                'volumecontrollerspots': './js/VolumeController/TabControllerSpots',
                'volumecontrollermapping': './js/VolumeController/TabControllerMapping',
                'volumespotscontroller': './js/VolumeController/VolumeSpotsController',
                'volumeworkspace': './js/VolumeController/VolumeWorkspace',
                'volumescene3d': './js/VolumeController/VolumeScene3D',
                'volumeviewgroup3d': './js/VolumeController/VolumeViewGroup3D',
                'volumeviewcontainer': './js/VolumeController/VolumeViewContainer',
                'volumeinputfilesprocessor': './js/VolumeController/VolumeInputFilesProcessor',
